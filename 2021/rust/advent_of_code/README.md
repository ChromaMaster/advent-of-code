...
Use the binary numbers in your diagnostic report to calculate_gamma_and_epsilon_rates the gamma rate and epsilon rate,
then multiply them together. **What is the power consumption of the submarine?** (Be sure to represent your answer in
decimal, not binary.)
...
Use the binary numbers in your diagnostic report to calculate_gamma_and_epsilon_rates the oxygen generator rating and
CO2 scrubber rating, then
...
as **the number of lines which cover that point** or . if no line covers that point. The top-left pair of 1s, for
